...
# 充值暂存区的指定文件，与上一次commit保持一致，但工作区不变
$ git reset [file]

# 重置暂存区与工作区，与上一次commit保持一致
$ git reset --hard

# 重置当前分支的指针指定commit，同时重置暂存区，但工作区不变
$ git reset [commit]
...
### 合成图
![Git常用操作.jpg](http://upload-images.jianshu.io/upload_images/10567362-ff0d680442cfcd4c.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
